<?php //netteCache[01]000217a:2:{s:4:"time";s:21:"0.66601100 1354976804";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:47:"/home/users/xd/xdlapa01/WWW/IIS/app/config.neon";i:2;i:1354976791;}}}?><?php
// source: /home/users/xd/xdlapa01/WWW/IIS/app/config.neon production

/**
 * @property AlbumRepository $albumRepository
 ...
 * @property DoplaciRepository $doplaciRepository
 * @property Nette\Http\Request $httpRequest
 * @property Nette\Http\Response $httpResponse
 * @property LekRepository $lekRepository
 * @property SystemContainer_nette $nette
 * @property ObsahovalRepository $obsahovalRepository
 * @property Nette\DI\NestedAccessor $php
 * @property PojistovnaRepository $pojistovnaRepository
 * @property ProdejRepository $prodejRepository
...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, router, nette.mailer, nette.database, pojistovnaRepository, prodejRepository, userRepository, obsahovalRepository, lekRepository, albumRepository, doplaciRepository, authenticator, container,
		...
		'repository' => FALSE, //: pojistovnaRepository, prodejRepository, userRepository, obsahovalRepository, lekRepository, doplaciRepository,
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/users/xd/xdlapa01/WWW/IIS/app',
			'wwwDir' => '/homes/eva/xd/xdlapa01/WWW/IIS/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/home/users/xd/xdlapa01/WWW/IIS/app/../temp',
		));
	}
	 ...
	 */
	protected function createServiceAlbumRepository()
	{
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/users/xd/xdlapa01/WWW/IIS/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	/**
	 * @return DoplaciRepository
	 */
	protected function createServiceDoplaciRepository()
	{
		$service = new DoplaciRepository($this->getService('nette.database.default'));
		return $service;
	}
	...
	/**
	 * @return LekRepository
	 */
	protected function createServiceLekRepository()
	{
		$service = new LekRepository($this->getService('nette.database.default'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/users/xd/xdlapa01/WWW/IIS/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:unix_socket=/var/run/mysql/mysql.sock;dbname=xdlapa01', 'xdlapa01', 'ejbesu8e', NULL);
	...
	{
		$service = new Nette\Application\PresenterFactory('/home/users/xd/xdlapa01/WWW/IIS/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/home/users/xd/xdlapa01/WWW/IIS/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	/**
	 * @return ObsahovalRepository
	 */
	protected function createServiceObsahovalRepository()
	{
		$service = new ObsahovalRepository($this->getService('nette.database.default'));
		return $service;
	}
	...
	/**
	 * @return PojistovnaRepository
	 */
	protected function createServicePojistovnaRepository()
	{
		$service = new PojistovnaRepository($this->getService('nette.database.default'));
		return $service;
	}


	/**
	 * @return ProdejRepository
	 */
	protected function createServiceProdejRepository()
	{
		$service = new ProdejRepository($this->getService('nette.database.default'));
		return $service;
	}
